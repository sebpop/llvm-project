...
;
entry:
  call void @llvm.assume(i1 true) ["array_info"(ptr %a, i64 2, i64 1024, i64 2048, i64 4)]
  br label %for.body
...
;
entry:
  call void @llvm.assume(i1 true) ["array_info"(ptr %a, i64 4, i64 1024, i64 1024, i64 1024, i64 2048, i64 4)]
  br label %for.body
