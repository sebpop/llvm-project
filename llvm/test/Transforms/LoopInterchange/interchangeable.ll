...
; RUN: opt < %s -passes=loop-interchange -cache-line-size=64 -verify-dom-info -verify-loop-info -verify-scev \
; RUN:     -verify-loop-lcssa -verify-memoryssa -S | FileCheck %s
; RUN: opt < %s -aa-pipeline=basic-aa -passes=loop-interchange -cache-line-size=64 -verify-dom-info \
; RUN:     -verify-loop-info -verify-scev -verify-loop-lcssa -verify-memoryssa -S | FileCheck %s
