...
; RUN: opt < %s -passes=loop-interchange -cache-line-size=4 -loop-interchange-threshold=-100 \
; RUN:     -verify-memoryssa -verify-dom-info -verify-loop-info -verify-scev -verify-loop-lcssa -S | FileCheck %s
