; REQUIRES: asserts
; RUN: opt < %s -passes='loop-mssa(loop-interchange),simplifycfg' -cache-line-size=64 \
; RUN:     -verify-memoryssa -simplifycfg-require-and-preserve-domtree=1 -pass-remarks-output=%t \
